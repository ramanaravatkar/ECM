 ...
 * web browser.
 */
public class Responsefilter_PropertyValidation extends PluginResponseFilter {
	...
	public void filter(String serverType, PluginServiceCallbacks callbacks, HttpServletRequest request,
		...
		Object jsonResponceObjref = jsonResponse.get("criterias");

		if (jsonResponceObjref instanceof com.ibm.json.java.JSONArray) {

			JSONArray criterias = (JSONArray) jsonResponceObjref;
			...
			for (Object item : criterias) {
				...
				String propsNames = (String) property.get("name");

				if (propsNames != null && !propsNames.isEmpty() && "AddedBy".equalsIgnoreCase(propsNames)) {

					property.put("readOnly", Boolean.TRUE);
