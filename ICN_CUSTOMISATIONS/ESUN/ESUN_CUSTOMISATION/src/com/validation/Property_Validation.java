...
import com.validation.service.GetAllowedOperationsService;
 ...
 * <p>
 */
public class Property_Validation extends Plugin {
	...
	public String getDojoModule() {
		return "property_ValidationDojo";
	}
	...
	public String getCSSFileName() {
		return "Property_Validation.css";
	}
	...
	public String getConfigurationDijitClass() {
		return "property_ValidationDojo.ConfigurationPane";
	}
	...
	public PluginService[] getServices() {
	    ...
	    if (pluginServices.length == 0) {
	        pluginServices = new PluginService[] {
	            new GetAllowedOperationsService()
	        };
	    }
	...
	public PluginResponseFilter[] getResponseFilters() {
		if (pluginResponseFilters.length == 0) {
			pluginResponseFilters = new PluginResponseFilter[] {new com.validation.Responsefilter_PropertyValidation()};
		}
	...
	/**
		...
		public PluginRequestFilter[] getRequestFilters() {
			if (pluginRequestFilters.length == 0) {
				pluginRequestFilters = new PluginRequestFilter[] {new com.validation.requestFilter.BlankSearchRequestFilter()};
			}
